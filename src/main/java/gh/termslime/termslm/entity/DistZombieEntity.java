...
public class DistZombieEntity extends Monster {
	public DistZombieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TermslimeModEntities.DIST_ZOMBIE.get(), world);
	}

	public DistZombieEntity(EntityType<DistZombieEntity> type, Level world) {
		super(type, world);
		xpReward = 32;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TermslimeModItems.DIST_DROP.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(TermslimeModEntities.DIST_ZOMBIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.KNOCKBACK_RESISTANCE, 214);
		builder = builder.add(Attributes.ATTACK_KNOCKBACK, 140);
		return builder;
	}
}
